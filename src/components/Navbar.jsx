    ...
    <div className='w-full flex items-center justify-between py-6 '>
      ...
      <div className='hidden md:flex items-center gap-4'>
        {links.map((link, index) => {
          return <div key={index} className={`${index === selected ? " bg-black dark:bg-slate-800 text-white" : " text-gray-700 dark:text-gray-500 "} px-6 py-2 rounded-full`} onClick={() => setSelected(index)}> 
            <a href="#"> {link} </a>
          </div>
        })}
      </div>
      ...
      <div className='flex items-center gap-10 2xl:gap-20'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='hidden md:block'>
            ...
            <span className='text-sm text-gray-700 dark:text-gray-500'>johndoe@gmail.com</span>
          </div>
